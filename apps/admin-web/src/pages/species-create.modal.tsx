...
import { canSubmitCreateSpecies } from './species-inventory.utils';
...
export function CreateSpeciesModal({
  ...
  onChangeInitialQuantity: (value: string) => void;
  ...
  const canSubmit = canSubmitCreateSpecies(
    commonName,
    botanicalName,
    initialQuantity,
    inventoryUnit,
  ...
  return (
    <div className="bakki-modal-shell" role="presentation">
      ...
      <section
        aria-labelledby="create-species-title"
        aria-modal="true"
      ...
      >
        <div className="task-monitoring-modal-body">
          <div className="task-monitoring-modal-head">
            <div>
              <span className="task-monitoring-modal-eyebrow">Species Setup</span>
              <h2 id="create-species-title">Add New Species</h2>
              <p>Create a species record with opening stock and field metadata.</p>
            </div>
          ...
          {errorMessage ? (
            <InlineStatusBanner
              heading="Species creation failed"
          ...
          <div className="task-monitoring-modal-grid">
            <label className="task-monitoring-modal-field">
              ...
              <input className="task-monitoring-modal-input" onChange={(event) => onChangeCode(event.target.value)} placeholder="Optional slug or internal code" type="text" value={code} />
            </label>
            <label className="task-monitoring-modal-field">
          ...
          <div className="task-monitoring-modal-grid">
            <label className="task-monitoring-modal-field">
              ...
              <input className="task-monitoring-modal-input" inputMode="numeric" min="0" onChange={(event) => onChangeInitialQuantity(event.target.value)} step="1" type="number" value={initialQuantity} />
            </label>
            <label className="task-monitoring-modal-field">
